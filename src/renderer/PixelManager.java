...
class PixelManager {
    ...
    void pixelDone() {
        ...
        synchronized (mutexPixels) {
            ++pixels;
            if (print) {
                percentage = (int) (1000 * pixels / totalPixels);
