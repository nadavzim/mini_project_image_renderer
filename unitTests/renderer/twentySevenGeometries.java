...
public class twentySevenGeometries {
    ...
    public void balls() {
        ...
        camera1.setImageWriter(imageWriter1) //
                .setRayTracer(new RayTracerBasic(scene1))//.setMultithreading(3) //
                .renderImage(); //
        camera1.writeToImage();//

        ImageWriter imageWriter2 = new ImageWriter("balls picture move right 450 and spin left 0.4", resolution, resolution);
        ...
        ImageWriter imageWriter3 = new ImageWriter("balls picture move right 450, towards 20,down 30 and spin left 0.35 and down 1", resolution, resolution);
